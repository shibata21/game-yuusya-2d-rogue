...
export const KIND_FIELD_LABELS = {
  ...
  evoLevel: ["進化段階", "通常・第一進化・第二進化を分ける目安。"],
  soilGrow: ["土壌育成量", "移動時に周囲の土壌へ加える養分量。"],
  weakenMs: ["弱体化時間", "攻撃を当てた冒険者の攻撃力を下げる時間ミリ秒。"],
  weakenMul: ["弱体化倍率", "弱体化中の冒険者の攻撃力倍率。小さいほど弱体化が強い。"],
  hitSlowMs: ["鈍足時間", "攻撃を当てた冒険者の移動を遅らせる時間ミリ秒。"],
  packBoost: ["群れ強化率", "近くにいる同族1体ごとの攻撃・移動強化率。"],
  chargeMs: ["突進持続時間", "移動後に突進攻撃が有効な時間ミリ秒。"],
  chargeMul: ["突進攻撃倍率", "移動直後の攻撃へ掛ける倍率。"],
  thorns: ["反射ダメージ", "隣接した冒険者から攻撃を受けた際の反撃ダメージ。"],
  skitter: ["高速移動倍率", "移動間隔へ掛ける倍率。小さいほど速い。"],
  frontGuard: ["正面防御率", "正面から受けるダメージの軽減率。"],
  idleRegen: ["自然回復率", "静止中に1秒ごとに回復する最大HP比率。"],
  guardAura: ["防御オーラ率", "近くの味方が受けるダメージの軽減率。"],
  heatTrailDmg: ["熱床ダメージ", "移動跡の熱床が冒険者へ与えるダメージ。"],
};
